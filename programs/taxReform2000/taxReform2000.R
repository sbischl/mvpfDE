...
taxReform2000 <- function (bootstrap_replication = 0, year_difference = 3) {
  ...
  fiscal_externality_before <-
    marginal_top_tax_rate_before / (1 - marginal_top_tax_rate_before) * estimates$pareto_coefficient_2002 * elasticity_of_taxable_income

  fiscal_externality_after <-
    marginal_top_tax_rate_after / (1 - marginal_top_tax_rate_after) * estimates$pareto_coefficient_2002 * elasticity_of_taxable_income
