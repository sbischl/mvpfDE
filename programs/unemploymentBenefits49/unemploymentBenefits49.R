...
# At the age of 44 the entitlement to UI benefits increases from 22 to 26 months

unemploymentBenefits49 <- function (bootstrap_replication = 0) {
  ...
  # Assumptions:
  #--------------------------------------------------------------------------------------------------------------------#
  max_benefit_duration <- 26
  max_benefit_duration_before_cutoff <- 22

  prices_year <- (1987 + 1999) / 2 # Autors use a dataset containing observations between July 1987 and March 1999

  non_employment_duration <-  20.5 # Schmieder et al. (2012) Online Appendix Table W1

  average_monthly_wage <- (63.3 * 365) / 12 # Schmieder et al. (2012) Online Appendix Table W1
  ...
  # Schmieder & von Wachter (2016) find a value of 0.14, the calculations above yield 0.156. Probably Schmieder & von Wachter (2016)
