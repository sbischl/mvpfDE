#----------------------------------------------------------------------------------------------------------------------#
# Unemployment Benefit Extension Age 42:
#----------------------------------------------------------------------------------------------------------------------#
...
# "Between July 1987 and March 1999, the potential UI duration for workers
# who were younger than 42 was 12 months. For workers between 42 and 43, potential UI duration increased to 18 months"
# -> The authors study a potential reform that would raise the unemploymebt benefit duration from 12 to 18 months
# for just below 42 year olds.

unemploymentBenefits42 <- function (bootstrap_replication = 0) {
  ...
  # Since the unemployment benefits are more generous in GER compared to US, an estimate towards the lower end of the distribution
  # seems reasonable.
  ...
  # Schmieder & von Wachter (2016) find a value of 0.12, the calculations above yield 0.133. Probably Schmieder & von Wachter (2016)
