...
startupSubsidy <- function (bootstrap_replication = 0,
  ...
  average_net_income_treatment <- 1672

  # From Caliendo & Künn (2011) Table 6 we know that the causal effect of participating in the start up subsidy program
  # is 435
  average_net_income_control <- average_net_income_treatment - 435
  ...
  subsidy <- sum(c(12*monthly_subsidy_year_1, 12 * monthly_subsidy_year_2, 12*monthly_subsidy_year_3) * discountVector(3))
