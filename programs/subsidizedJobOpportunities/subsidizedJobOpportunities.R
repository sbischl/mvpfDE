...
subsidizedJobOpportunities <- function (bootstrap_replication = 0, extend_effect = 0) {
  ...
  total_west <- 9.6
  total_east <- 16.3
  share_female_conditional_on_west <- 0.363
  share_female_conditional_on_east <- 0.416
  ...
  # (Monthly) effect on gross earnings:
  ...
  # (Monthly) effect on benefit payed:
  ...
  average_age_female_west <- 31.909
  average_age_male_west <- 31.591
  average_age_female_east <- 36.201
  average_age_male_east <- 34.6845
