...
```{r echo = FALSE, fig.align = 'center', fig.width = 8, fig.height = 2.4, fig.showtext=TRUE}
makePlot("tuitionFees", "cost", "Zahlungsbereitschaft für die Abschaffung des Schulgeldes")
```
...
```{r echo = FALSE, fig.align = 'center', fig.width = 8, fig.height = 2.4, fig.showtext=TRUE}
makePlot("tuitionFees", "cost", "Kostenkomposition der Abschaffung des Schulgeldes")
```
